    ...
    <div className="w-full max-w-2xl mx-auto mt-8 bg-white rounded-xl shadow-lg overflow-hidden animate-fade-in">
      <div className="p-6 md:p-8">
        ...
        <div className="space-y-5">
            <InfoSection title="Description" icon={<DescriptionIcon />}>
            ...
            <InfoSection title="Common Treatment Options" icon={<TreatmentIcon />}>
                <p>{data.treatmentOptions}</p>
            </InfoSection>

            <InfoSection title="Multidisciplinary Approach" icon={<MultiDisciplinaryIcon />}>
                <p>{data.multidisciplinaryApproach}</p>
            </InfoSection>
